...
public class HomeServlet extends HttpServlet {
    ...
    @Inject
    public HomeServlet(@Named("signature") HashService signatureService, Connection connection, UserDao userDao, TokenDao tokenDao) {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("hash", userDao.installTables() && tokenDao.installTables() ? "Ok":"Failed");
